...
const FAQs = () => {
  ...
  const handleAddFAQs = async (values: {
    ...
    try {
      ...
      if (error) {
        showToast("Error in adding FAQ","error");
        console.log(`Error adding FAQ: ${error}`);
      } else {
        showToast("Successfully added FAQ", "success");
  ...
  const handleEditFAQs = async (values: {
    ...
    try {
      ...
      if (error) {
        ...
        showToast("Successfully updated FAQ", "updated");
        setFaqs(
          faqs
  ...
  const handleDeleteFAQs = async (id: string) => {
    try {
      ...
      if (error) {
        ...
        showToast("Successfully deleted FAQ", "deleted");
        loadFaqs();
      }
    } catch (error) {
